...
def _seed_cuentas(conn):
    ...
    cuentas_default = [
        ...
        ("1.1.03", "Caja Chica", "activo", "corriente", "Fondo fijo de gastos menores"),
        ("1.1.04", "Clientes / Cuentas por Cobrar", "activo", "corriente", "Derechos de cobro por ventas"),
        ("1.1.05", "Documentos por Cobrar", "activo", "corriente", "Pagarés y letras a favor"),
        ("1.1.06", "Mercaderías / Inventario", "activo", "corriente", "Stock de bienes para la venta"),
        ("1.1.07", "Materias Primas", "activo", "corriente", "Insumos para producción"),
        ("1.1.08", "IVA Crédito Fiscal", "activo", "corriente", "IVA pagado en compras"),
        ("1.1.09", "Anticipos a Proveedores", "activo", "corriente", "Pagos adelantados a proveedores"),
        ("1.1.10", "Gastos Pagados por Anticipado", "activo", "corriente", "Seguros, alquileres prepagados"),
        ("1.1.11", "Inversiones Temporarias", "activo", "corriente", "Depósitos a plazo fijo corto"),
